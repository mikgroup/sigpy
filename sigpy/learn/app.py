    ...
    def _summarize(self):
        if self.checkpoint_path is not None:
            ...
            with self.device:
                ...
                x = sp.convolve(self.R_t, self.L, mode=self.mode,
                                input_multi_channel=True, output_multi_channel=self.multi_channel)
...
class ConvSparseCoefficients(object):
    ...
    def __getitem__(self, index):
        ...
        with self.device:
            return ConvSparseDecom(y_t, self.L, lamda=self.lamda,
